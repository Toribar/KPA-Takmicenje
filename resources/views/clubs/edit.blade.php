...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {{ Form::open(['url' => route('clubs.update', $club->id), 'method' => 'patch', 'class' => 'form-horizontal']) }}
                <div class="form-group {{ $errors->has('name') ? 'has-error' : null }}">
                    <label class="col-md-3 control-label">Ime kluba</label>

                    <div class="col-md-6">
                        {{ Form::text('name', old('name', $club->name), ['class' => 'form-control']) }}
                ...
                <div class="form-group {{ $errors->has('location') ? 'has-error' : null }}">
                    ...
                    <div class="col-md-6">
                        {{ Form::text('location', old('location', $club->location), ['class' => 'form-control']) }}
